...
class SPF_Elementor_Widget extends Widget_Base {
    ...
    private function register_style_controls(): void {
        ...
        $this->add_responsive_control( 'field_spacing', array(
            ...
            'selectors'  => array(
                '{{WRAPPER}} .spf-field-group' => 'margin-bottom: {{SIZE}}{{UNIT}};',
                '{{WRAPPER}} .spf-fields-grid' => 'gap: {{SIZE}}{{UNIT}};',
            ),
            'separator' => 'before',
        ) );
        ...
        $this->add_responsive_control( 'field_padding', array(
            ...
            'selectors'  => array(
                '{{WRAPPER}} .spf-input, {{WRAPPER}} .spf-select, {{WRAPPER}} .spf-textarea' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
            ),
        ) );
        ...
        $this->add_responsive_control( 'btn_padding', array(
            ...
            'size_units' => array( 'px', 'em' ),
            'selectors'  => array(
                '{{WRAPPER}} .spf-submit-btn' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
            ),
        ) );
        ...
        $this->add_responsive_control( 'form_width', array(
            ...
            'selectors'  => array(
                '{{WRAPPER}} .spf-form-wrapper' => 'max-width: {{SIZE}}{{UNIT}};',
            ),
        ) );
        ...
        $this->add_responsive_control( 'form_padding', array(
            ...
            'size_units' => array( 'px', 'em' ),
            'selectors'  => array(
                '{{WRAPPER}} .spf-form-wrapper' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
            ),
        ) );
        ...
        $this->add_control( 'form_border_radius', array(
            ...
            'size_units' => array( 'px' ),
            'selectors'  => array(
                '{{WRAPPER}} .spf-form-wrapper' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
            ),
        ) );
        ...
        $this->add_control( 'form_bg', array(
            ...
            'type'      => Controls_Manager::COLOR,
            'selectors' => array(
                '{{WRAPPER}} .spf-form-wrapper' => 'background-color: {{VALUE}};',
            ),
        ) );
        ...
        $this->add_responsive_control( 'popup_padding', array(
            ...
            'size_units' => array( 'px', 'em' ),
            'selectors'  => array(
                '{{WRAPPER}} .spf-modal' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
            ),
        ) );
        ...
        $this->add_responsive_control( 'popup_btn_padding', array(
            ...
            'size_units' => array( 'px', 'em' ),
            'selectors'  => array(
                '{{WRAPPER}} .spf-modal-btn--reset' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
            ),
        ) );
